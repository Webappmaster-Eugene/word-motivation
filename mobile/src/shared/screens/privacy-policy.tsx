...
const SECTIONS: readonly LegalSection[] = [
  {
    ...
    body:
      'Baby-funner — детская образовательная игра. Мы не знаем имя ребёнка, не спрашиваем ' +
  ...
  },
  {
    ...
    body:
      ...
      'сам идентификатор. Запрос направляйте на support@nadtocheev.ru.',
  },
  {
    title: 'Контакт',
    body:
      'По любым вопросам пишите на support@nadtocheev.ru. Родительское согласие предполагается ' +
